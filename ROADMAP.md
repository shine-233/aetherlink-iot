...
- ~~**`TB-12` 设备认领与自动注册**~~ → **后端全链路已闭环（2026-09-19）**：见 §7.1 该行与 `docs/validation/2026-09-19-tb12-device-claiming-evidence.md`；剩前端 UI 接线（`未接线`）。
