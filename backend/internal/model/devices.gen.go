...
// 文件用途：定义 devices 的生成模型结构及其数据库表映射，作为 backend/internal/model 的持久化模型边界。
...
type Device struct {
	...
	OwnerUserID    *string    `gorm:"column:owner_user_id;comment:设备拥有者用户ID" json:"owner_user_id"`                                    // 设备拥有者用户ID
