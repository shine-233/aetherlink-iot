...
func newAlarmConfig(db *gorm.DB, opts ...gen.DOOption) alarmConfig {
	...
	_alarmConfig.TriggerDuration = field.NewInt32(tableName, "trigger_duration")
...
type alarmConfig struct {
	...
	TriggerDuration     field.Int32  // 告警条件需连续成立的秒数0-立即触发
...
func (a *alarmConfig) updateTableName(table string) *alarmConfig {
	...
	a.TriggerDuration = field.NewInt32(table, "trigger_duration")
...
func (a *alarmConfig) fillFieldMap() {
	...
	a.fieldMap["trigger_duration"] = a.TriggerDuration
}
