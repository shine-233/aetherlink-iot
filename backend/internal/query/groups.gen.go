...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.OwnerUserID = field.NewString(tableName, "owner_user_id")
...
type group struct {
	...
	OwnerUserID field.String // 分组拥有者用户ID
...
func (g *group) updateTableName(table string) *group {
	...
	g.OwnerUserID = field.NewString(table, "owner_user_id")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["owner_user_id"] = g.OwnerUserID
}
