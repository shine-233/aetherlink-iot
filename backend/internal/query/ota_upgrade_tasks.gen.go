...
// 文件用途: 提供 GORM Gen 生成的类型安全查询代码，承接 model 与 DAL 之间的表级访问入口。
// 核心逻辑: 由 GORM Gen 根据数据库模型生成字段、条件、关联和基础 CRUD 封装，业务侧不应手工改写生成主体。
// 关键注意事项: 生成边界以 gorm.io/gen 输出为准，租户/权限/事务规则应在 service 或 DAL 手写层收口后再调用。
// 重构建议: 如需调整查询形态，优先修改生成配置或新增 DAL 包装方法，并在重新生成后复查差异。
...
func newOtaUpgradeTask(db *gorm.DB, opts ...gen.DOOption) otaUpgradeTask {
	...
	_otaUpgradeTask.TargetMode = field.NewString(tableName, "target_mode")
	_otaUpgradeTask.TargetFilter = field.NewString(tableName, "target_filter")
	_otaUpgradeTask.PreviewTotal = field.NewInt64(tableName, "preview_total")
	_otaUpgradeTask.SelectedCount = field.NewInt(tableName, "selected_count")
	_otaUpgradeTask.CreatedBy = field.NewString(tableName, "created_by")
	_otaUpgradeTask.CreatedByAuthority = field.NewString(tableName, "created_by_authority")
...
type otaUpgradeTask struct {
	...
	TargetMode          field.String // OTA target mode
	TargetFilter        field.String // OTA target filter snapshot
	PreviewTotal        field.Int64  // Backend preview total at creation
	SelectedCount       field.Int    // Selected device count at creation
	CreatedBy           field.String // Creator user id
	CreatedByAuthority  field.String // Creator authority
...
func (o *otaUpgradeTask) updateTableName(table string) *otaUpgradeTask {
	...
	o.TargetMode = field.NewString(table, "target_mode")
	o.TargetFilter = field.NewString(table, "target_filter")
	o.PreviewTotal = field.NewInt64(table, "preview_total")
	o.SelectedCount = field.NewInt(table, "selected_count")
	o.CreatedBy = field.NewString(table, "created_by")
	o.CreatedByAuthority = field.NewString(table, "created_by_authority")
...
func (o *otaUpgradeTask) fillFieldMap() {
	...
	o.fieldMap["target_mode"] = o.TargetMode
	o.fieldMap["target_filter"] = o.TargetFilter
	o.fieldMap["preview_total"] = o.PreviewTotal
	o.fieldMap["selected_count"] = o.SelectedCount
	o.fieldMap["created_by"] = o.CreatedBy
	o.fieldMap["created_by_authority"] = o.CreatedByAuthority
}
