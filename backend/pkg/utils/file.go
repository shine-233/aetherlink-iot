// 文件用途：提供 file 相关的后端通用工具能力。
// 核心逻辑：封装可复用的格式处理、校验、加密、脚本或命令构造逻辑，供业务层按需调用，主要围绕 func FileExist、func CheckPath、func CheckFilename、func FileSign 等声明展开。
...
var (
	...
	allowUpgradePackageMap = map[string]bool{
		".bin": true, ".hex": true, ".elf": true, ".tar": true, ".gz": true, ".zip": true,
