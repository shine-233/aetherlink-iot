...
CREATE TABLE public."groups" (
	...
	owner_user_id varchar(36) NULL, -- 分组拥有者用户ID
...
CREATE TABLE public.ota_upgrade_tasks (
	...
	created_at timestamptz(6) NOT NULL, -- 创建时间
	remark varchar(255) NULL, -- 备注
	target_mode varchar(32) NOT NULL DEFAULT 'explicit', -- OTA target mode: explicit or filter
	target_filter jsonb NULL, -- OTA target filter snapshot
	preview_total int8 NULL, -- Backend preview total at creation time
	selected_count int4 NULL, -- Selected device count at creation time
	created_by varchar(36) NULL, -- Creator user id
	created_by_authority varchar(64) NULL, -- Creator authority
...
-- public.telemetry_dead_letters definition

-- Drop table

-- DROP TABLE public.telemetry_dead_letters;
...
CREATE TABLE public.telemetry_dead_letters (
	...
	status varchar(36) NOT NULL DEFAULT 'pending'::character varying,
...
-- 24小时分区
-- Local development may use plain PostgreSQL without TimescaleDB installed.
-- Guard the hypertable call so the rest of the schema can still be created.
DO $$
BEGIN
...
CREATE TABLE public.devices (
	...
	owner_user_id varchar(36) NULL, -- 设备拥有者用户ID
...
-- System administrator and automation users must be created by deployment bootstrap
-- or ignored local seed files. Keep this disabled tenant row only as non-login sample data.
INSERT INTO public.users (id, "name", phone_number, email, status, authority, "password", tenant_id, remark, additional_info, created_at, updated_at) VALUES('11111111-4fe9-b409-67c3-111111111111', 'Disabled Tenant Sample', '+86 13166666666', 'disabled.tenant@example.invalid', 'F', 'TENANT_ADMIN', 'DISABLED_PUBLIC_SEED_ACCOUNT_NO_LOGIN', 'd616bcbb', 'disabled public seed sample', '{}'::json, '2024-06-05 16:48:11.097', '2024-06-05 16:48:11.097');
...
INSERT INTO public.data_policy (id, data_type, retention_days, last_cleanup_time, last_cleanup_data_time, enabled, remark) VALUES('a', '1', 30, '2024-06-05 10:02:00.003', '2024-05-21 10:02:00.101', '1', '');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('c078182f-bf4b-b560-da97-02926fa98f78', '650bc444-7672-1123-1e41-7e37365b0186', 'alarm_notification-record', 3, 1, '/alarm/notification-record', 'mdi:pencil-box-outline', 'self', '["TENANT_ADMIN"]'::json, '通知记录', '2024-03-20 10:04:34.927', '', 'route.alarm_notification-record', 'view.alarm_notification-record');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('5373a6a2-1861-af35-eb4c-adfd5ca55ecd', '0', 'device', 1, 112, '/device', 'mdi:view-dashboard-outline', '0', '["TENANT_ADMIN"]'::json, '设备接入', '2024-03-05 17:51:19.298', '', 'route.device', 'layout.base');
...
INSERT INTO public.logo (id, system_name, logo_cache, logo_background, logo_loading, home_background, remark) VALUES('a', 'AetherLink IoT', '', '', '', '', NULL);
