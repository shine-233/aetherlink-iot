...
// 文件用途：保存 tp_to_db.proto 生成的 protobuf 消息、枚举和序列化描述。
// 核心逻辑：由 protoc-gen-go 生成 Go 结构体、反射元数据和二进制编解码支持。
// 关键注意事项：这是生成文件，不要手工修改业务字段；协议变更必须从 .proto 源文件重新生成。
// 重构建议：建议补齐 proto 源文件和生成脚本，并在 CI 中校验生成代码与协议源一致。
package tptodb
...
var file_tp_to_db_proto_depIdxs = []int32{
	...
	2,  // 1: tptodb.AetherLink.GetDeviceHistory:input_type -> tptodb.GetDeviceHistoryRequest
	12, // 2: tptodb.AetherLink.GetDeviceHistoryWithPageAndPage:input_type -> tptodb.GetDeviceHistoryWithPageAndPageRequest
	4,  // 3: tptodb.AetherLink.GetDeviceAttributesHistory:input_type -> tptodb.GetDeviceAttributesHistoryRequest
	6,  // 4: tptodb.AetherLink.GetDeviceAttributesCurrents:input_type -> tptodb.GetDeviceAttributesCurrentsRequest
	14, // 5: tptodb.AetherLink.GetDeviceAttributesCurrentList:input_type -> tptodb.GetDeviceAttributesCurrentListRequest
	8,  // 6: tptodb.AetherLink.GetDeviceKVDataWithNoAggregate:input_type -> tptodb.GetDeviceKVDataWithNoAggregateRequest
	10, // 7: tptodb.AetherLink.GetDeviceKVDataWithAggregate:input_type -> tptodb.GetDeviceKVDataWithAggregateRequest
	1,  // 8: tptodb.Greeter.SayHello:output_type -> tptodb.HelloReply
	3,  // 9: tptodb.AetherLink.GetDeviceHistory:output_type -> tptodb.GetDeviceHistoryReply
	13, // 10: tptodb.AetherLink.GetDeviceHistoryWithPageAndPage:output_type -> tptodb.GetDeviceHistoryWithPageAndPageReply
	5,  // 11: tptodb.AetherLink.GetDeviceAttributesHistory:output_type -> tptodb.GetDeviceAttributesHistoryReply
	7,  // 12: tptodb.AetherLink.GetDeviceAttributesCurrents:output_type -> tptodb.GetDeviceAttributesCurrentsReply
	15, // 13: tptodb.AetherLink.GetDeviceAttributesCurrentList:output_type -> tptodb.GetDeviceAttributesCurrentListReply
	9,  // 14: tptodb.AetherLink.GetDeviceKVDataWithNoAggregate:output_type -> tptodb.GetDeviceKVDataWithNoAggregateReply
	11, // 15: tptodb.AetherLink.GetDeviceKVDataWithAggregate:output_type -> tptodb.GetDeviceKVDataWithAggregateReply
