<!--
文件用途：实现后台管理布局组件的结构和插槽。
核心逻辑：根据 props 计算布局 CSS 变量，并渲染页头、页签、侧栏、内容区、页脚和移动端遮罩。
关键注意事项：插槽名称、CSS Module 类名和布局类型需要保持同步，移动端层级依赖 shared 常量。
重构建议：可补充插槽契约文档，并为 CSS 变量生成逻辑增加测试。
-->
