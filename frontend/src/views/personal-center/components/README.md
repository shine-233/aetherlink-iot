# frontend/src/views/personal-center/components 目录说明

## 目录职责

本目录存放 `frontend/src/views/personal-center/components` 对应的前端页面、局部组件或页面级支撑文件，属于 `frontend/src/views` 文档化第一分片。

## 内容结构

- 主要文件：`change-information.vue`
- 子目录：`__tests__/`
