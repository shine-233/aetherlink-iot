// 文件用途：标注 server\service_mock.go 的生成或模拟代码维护边界。
...
// TerminateClientIfCurrent mocks base method
func (m *MockClientService) TerminateClientIfCurrent(client Client) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TerminateClientIfCurrent", client)
	ret0, _ := ret[0].(bool)
	return ret0
}

// TerminateClientIfCurrent indicates an expected call of TerminateClientIfCurrent
func (mr *MockClientServiceMockRecorder) TerminateClientIfCurrent(client interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TerminateClientIfCurrent", reflect.TypeOf((*MockClientService)(nil).TerminateClientIfCurrent), client)
}
